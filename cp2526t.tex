...
Uma unidade militar envia a mensagem \ensuremath{\Varid{words}\;\text{\ttfamily \char34 Vamos~atacar~hoje\char34}} através de um aparelho
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{pcataList}\mathbin{::}(()+(\Varid{a},\fun{Dist}\;\Varid{b})\to \fun{Dist}\;\Varid{b})\to [\mskip1.5mu \Varid{a}\mskip1.5mu]\to \fun{Dist}\;\Varid{b}{}\<[E]%
\\
...
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{h}\;(\Varid{x}\mathbin{:}\Varid{xs})\mathrel{=}\Varid{h}\;\Varid{xs}\bind \lambda \Varid{r}\to \Varid{g}\;(i_2\;(\Varid{x},\Varid{return}\;\Varid{r})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks

O catamorfismo processa a lista recursivamente, aplicando o gene em cada passo.
A composição monádica (\ensuremath{\bind }) garante que as probabilidades se propagam
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{gene}\mathbin{::}()+(\Conid{String},\fun{Dist}\;[\mskip1.5mu \Conid{String}\mskip1.5mu])\to \fun{Dist}\;[\mskip1.5mu \Conid{String}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{gene}\;(i_1\;())\mathrel{=}\Varid{choose}\;\mathrm{0.9}\;[\mskip1.5mu \text{\ttfamily \char34 stop\char34}\mskip1.5mu]\;[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{gene}\;(i_2\;(\Varid{word},\Varid{distTail}))\mathrel{=}\mathbf{do}\;\Varid{tail}\leftarrow \Varid{distTail}{}\<[E]%
\\
\>[B]{}\hsindent{36}{}\<[36]%
\>[36]{}\Varid{choose}\;\mathrm{0.95}\;(\Varid{word}\mathbin{:}\Varid{tail})\;\Varid{tail}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks

O gene descreve o comportamento passo-a-passo:
\begin{itemize}
    \item \textbf{Caso base} (\ensuremath{i_1\;()}): Transmite "stop" com 90\% de sucesso, falha com 10\%
    \item \textbf{Caso recursivo} (\ensuremath{i_2}): Para cada palavra, transmite-a com 95\% de probabilidade
    ou a perde com 5\% de probabilidade
\end{itemize}

\textbf{Análise Probabilística}

Para a mensagem \ensuremath{[\mskip1.5mu \text{\ttfamily \char34 Vamos\char34},\text{\ttfamily \char34 atacar\char34},\text{\ttfamily \char34 hoje\char34}\mskip1.5mu]}:

\begin{enumerate}
\item \textbf{Perder apenas "atacar"}: Resultado \ensuremath{[\mskip1.5mu \text{\ttfamily \char34 Vamos\char34},\text{\ttfamily \char34 hoje\char34},\text{\ttfamily \char34 stop\char34}\mskip1.5mu]}
...
\item \textbf{Sem "stop" final}: Resultado \ensuremath{[\mskip1.5mu \text{\ttfamily \char34 Vamos\char34},\text{\ttfamily \char34 atacar\char34},\text{\ttfamily \char34 hoje\char34}\mskip1.5mu]}
...
\item \textbf{Transmissão perfeita}: Resultado \ensuremath{[\mskip1.5mu \text{\ttfamily \char34 Vamos\char34},\text{\ttfamily \char34 atacar\char34},\text{\ttfamily \char34 hoje\char34},\text{\ttfamily \char34 stop\char34}\mskip1.5mu]}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{testTransmission}\mathrel{=}\Varid{transmitir}\;(\Varid{words}\;\text{\ttfamily \char34 Vamos~atacar~hoje\char34}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{probPerfecta}\mathrel{=}(\equiv [\mskip1.5mu \text{\ttfamily \char34 Vamos\char34},\text{\ttfamily \char34 atacar\char34},\text{\ttfamily \char34 hoje\char34},\text{\ttfamily \char34 stop\char34}\mskip1.5mu])\mathbin{??}\Varid{testTransmission}{}\<[E]%
\\
\>[B]{}\Varid{probSemStop}\mathrel{=}(\equiv [\mskip1.5mu \text{\ttfamily \char34 Vamos\char34},\text{\ttfamily \char34 atacar\char34},\text{\ttfamily \char34 hoje\char34}\mskip1.5mu])\mathbin{??}\Varid{testTransmission}{}\<[E]%
\\
\>[B]{}\Varid{probPerdaAtacar}\mathrel{=}(\equiv [\mskip1.5mu \text{\ttfamily \char34 Vamos\char34},\text{\ttfamily \char34 hoje\char34},\text{\ttfamily \char34 stop\char34}\mskip1.5mu])\mathbin{??}\Varid{testTransmission}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
O catamorfismo probabilístico \ensuremath{\Varid{pcataList}} generaliza o catamorfismo clássico de listas,

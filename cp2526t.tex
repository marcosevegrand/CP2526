...
e nó com valor \ensuremath{\Varid{a}} e subárvores processadas (cria um novo nível com \ensuremath{\Varid{a}} e funde os restantes).\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathbin{/}\cdot \div \cdot \mathbin{>}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks

...
O diagrama mostra como \ensuremath{\Varid{levels}} decompõe a árvore (via $\mathtt{in_{BTree}}$),
...
\xymatrix@C=1.5cm{
    \ensuremath{[\mskip1.5mu \Conid{BTree}\;\Varid{a}\mskip1.5mu]}
           \ar[d]_-{\ensuremath{\Varid{bft}}}
           \ar[r]^-{\ensuremath{\Varid{gbf}}}
&
...
A operação \ensuremath{\Varid{ts}\mathbin{+\!\!+}[\mskip1.5mu \Varid{l},\Varid{r}\mskip1.5mu]} coloca os filhos no fim, não no início, mantendo a ordem breadth-first.
...
\begin{itemize}
    ...
    \item \ensuremath{\Varid{h}}: Numerador do termo atual ($x^{2n+1}$).
    \item \ensuremath{\Varid{k}}: Denominador do termo atual ($(2n+1)!$).
...
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{worker}\mathrel{=}\cataNat{\Varid{gene}}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{gene}\mathrel{=}\alt{\underline{\Varid{start}\;\Varid{x}}}{\Varid{loop}\;\Varid{x}}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{loop}\;\Varid{x}\;[\mskip1.5mu \Varid{s},\Varid{h},\Varid{k},\Varid{j},\Varid{m}\mskip1.5mu]\mathrel{=}[\mskip1.5mu \Varid{h}\mathbin{/}\Varid{k}\mathbin{+}\Varid{s},\Varid{x}\mathbin{\uparrow}\mathrm{2}\mathbin{*}\Varid{h},\Varid{k}\mathbin{*}\Varid{j},\Varid{j}\mathbin{+}\Varid{m},\Varid{m}\mathbin{+}\mathrm{8}\mskip1.5mu]{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
...
O objectivo é expressar a função \ensuremath{\Varid{fair\char95 merge}} como um anamorfismo de streams,
derivando o gene a partir da lei dual da recursividade mútua.

\textbf{Ponto de partida: a definição dada}

A função \ensuremath{\Varid{fair\char95 merge}} é definida por duas funções mutuamente recursivas:
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{h}\;(\Conid{Cons}\;(\Varid{x},\Varid{xs}),\Varid{y})\mathrel{=}\Conid{Cons}\;(\Varid{x},\Varid{k}\;(\Varid{xs},\Varid{y})){}\<[E]%
\\
\>[B]{}\Varid{k}\;(\Varid{x},\Conid{Cons}\;(\Varid{y},\Varid{ys}))\mathrel{=}\Conid{Cons}\;(\Varid{y},\Varid{h}\;(\Varid{x},\Varid{ys})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
onde \ensuremath{\Varid{h}} extrai do primeiro stream e \ensuremath{\Varid{k}} extrai do segundo, alternando entre si.

A função final é \ensuremath{\Varid{fair\char95 merge}\mathrel{=}\alt{\Varid{h}}{\Varid{k}}}, que escolhe entre começar por \ensuremath{\Varid{h}} ou \ensuremath{\Varid{k}}
conforme o argumento seja \ensuremath{i_1} ou \ensuremath{i_2}.

\textbf{Derivação da lei dual da recursividade mútua}

Queremos encontrar um gene \ensuremath{\Varid{g}} tal que \ensuremath{\alt{\Varid{h}}{\Varid{k}}\mathrel{=}\lanabracket\,\Varid{g}\,\ranabracket}.
Partindo da propriedade universal dos anamorfismos:
\begin{eqnarray*}
\start
    \ensuremath{\Varid{f}\mathrel{=}\lanabracket\,\Varid{g}\,\ranabracket}
\just\equiv{ universal-ana (56) }
    \ensuremath{\mathsf{out}\comp \Varid{f}\mathrel{=}(\Varid{id}\times\Varid{f})\comp \Varid{g}}
\end{eqnarray*}

Aplicando a \ensuremath{\Varid{f}\mathrel{=}\alt{\Varid{h}}{\Varid{k}}} e \ensuremath{\Varid{g}\mathrel{=}\alt{\Varid{gh}}{\Varid{gk}}}:
\begin{eqnarray*}
\start
    \ensuremath{\alt{\Varid{h}}{\Varid{k}}\mathrel{=}\lanabracket\,\alt{\Varid{gh}}{\Varid{gk}}\,\ranabracket}
\just\equiv{ universal-ana (56) }
    \ensuremath{\mathsf{out}\comp \alt{\Varid{h}}{\Varid{k}}\mathrel{=}(\Varid{id}\times\alt{\Varid{h}}{\Varid{k}})\comp \alt{\Varid{gh}}{\Varid{gk}}}
\just\equiv{ fusão-+ (21) }
    \ensuremath{\alt{\mathsf{out}\comp \Varid{h}}{\mathsf{out}\comp \Varid{k}}\mathrel{=}\alt{(\Varid{id}\times\alt{\Varid{h}}{\Varid{k}})\comp \Varid{gh}}{(\Varid{id}\times\alt{\Varid{h}}{\Varid{k}})\comp \Varid{gk}}}
\just\equiv{ eq-+ (28) }
\ensuremath{\begin{lcbr}\mathsf{out}\comp \Varid{h}\mathrel{=}(\Varid{id}\times\alt{\Varid{h}}{\Varid{k}})\comp \Varid{gh}\\\mathsf{out}\comp \Varid{k}\mathrel{=}(\Varid{id}\times\alt{\Varid{h}}{\Varid{k}})\comp \Varid{gk}\end{lcbr}}
\qed
\end{eqnarray*}

A lei dual da recursividade mútua permitiu derivar os genes \ensuremath{\Varid{gh}} e \ensuremath{\Varid{gk}}
a partir das funções mutuamente recursivas \ensuremath{\Varid{h}} e \ensuremath{\Varid{k}}.

\textbf{Aplicação ao fair-merge}

Calculemos \ensuremath{\mathsf{out}\comp \Varid{h}} e \ensuremath{\mathsf{out}\comp \Varid{k}}:
\begin{eqnarray*}
\start
\ensuremath{\mathsf{out}\comp \Varid{h}\;(\Conid{Cons}\;(\Varid{x},\Varid{xs}),\Varid{y})}
\just={definição de \ensuremath{\Varid{h}}}
\ensuremath{\mathsf{out}\;(\Conid{Cons}\;(\Varid{x},\Varid{k}\;(\Varid{xs},\Varid{y})))}
\just={definição de \ensuremath{\mathsf{out}}}
\ensuremath{(\Varid{x},\Varid{k}\;(\Varid{xs},\Varid{y}))}
\just={cancelamento-+ (19)}
\ensuremath{(\Varid{x},\alt{\Varid{h}}{\Varid{k}}\;(i_2\;(\Varid{xs},\Varid{y})))}
\just={def-× (79)}
\ensuremath{(\Varid{id}\times\alt{\Varid{h}}{\Varid{k}})\;(\Varid{x},i_2\;(\Varid{xs},\Varid{y}))}
\qed
\end{eqnarray*}

Portanto, \ensuremath{\Varid{gh}\;(\Conid{Cons}\;(\Varid{x},\Varid{xs}),\Varid{y})\mathrel{=}(\Varid{x},i_2\;(\Varid{xs},\Varid{y}))}.

Analogamente para \ensuremath{\Varid{k}}:
\begin{eqnarray*}
\start
\ensuremath{\mathsf{out}\comp \Varid{k}\;(\Varid{x},\Conid{Cons}\;(\Varid{y},\Varid{ys}))}
\just={definição de \ensuremath{\Varid{k}}}
\ensuremath{\mathsf{out}\;(\Conid{Cons}\;(\Varid{y},\Varid{h}\;(\Varid{x},\Varid{ys})))}
\just={definição de \ensuremath{\mathsf{out}}}
\ensuremath{(\Varid{y},\Varid{h}\;(\Varid{x},\Varid{ys}))}
\just={cancelamento-+ (19)}
\ensuremath{(\Varid{y},\alt{\Varid{h}}{\Varid{k}}\;(i_1\;(\Varid{x},\Varid{ys})))}
\just={def-× (79)}
\ensuremath{(\Varid{id}\times\alt{\Varid{h}}{\Varid{k}})\;(\Varid{y},i_1\;(\Varid{x},\Varid{ys}))}
\qed
\end{eqnarray*}

Portanto, \ensuremath{\Varid{gk}\;(\Varid{x},\Conid{Cons}\;(\Varid{y},\Varid{ys}))\mathrel{=}(\Varid{y},i_1\;(\Varid{x},\Varid{ys}))}.

\textbf{O gene do anamorfismo}

Combinando \ensuremath{\Varid{gh}} e \ensuremath{\Varid{gk}} num único gene \ensuremath{\Varid{gene}\mathrel{=}\alt{\Varid{gh}}{\Varid{gk}}}:
\begin{eqnarray*}
    \ensuremath{\Varid{gene}\;(i_1\;(\Conid{Cons}\;(\Varid{x},\Varid{xs}),\Varid{y}))} &=& \ensuremath{(\Varid{x},i_2\;(\Varid{xs},\Varid{y}))} \\
    \ensuremath{\Varid{gene}\;(i_2\;(\Varid{x},\Conid{Cons}\;(\Varid{y},\Varid{ys})))} &=& \ensuremath{(\Varid{y},i_1\;(\Varid{x},\Varid{ys}))}
\end{eqnarray*}
...
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{gene}\;(i_1\;{}\<[17]%
\>[17]{}(\Conid{Cons}\;(\Varid{x},\Varid{xs}),\Varid{y}))\mathrel{=}(\Varid{x},i_2\;(\Varid{xs},\Varid{y})){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{gene}\;(i_2\;(\Varid{x},\Conid{Cons}\;(\Varid{y},\Varid{ys})))\mathrel{=}(\Varid{y},i_1\;{}\<[48]%
\>[48]{}(\Varid{x},\Varid{ys})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
\xymatrix@C=1.5cm{
    \ensuremath{(\Conid{S},\Conid{S})\mathbin{+}(\Conid{S},\Conid{S})}
           \ar[d]_-{\ensuremath{\Varid{fair\char95 merge'}}}
           \ar[r]^-{\ensuremath{\Varid{gene}}}
&
    \ensuremath{\Varid{a}\times((\Conid{S},\Conid{S})\mathbin{+}(\Conid{S},\Conid{S}))}
           \ar[d]^{\ensuremath{\Varid{id}\times\Varid{fair\char95 merge'}}}
\\
    \ensuremath{\Conid{S}}
&
    \ensuremath{\Varid{a}\times\Conid{S}}
           \ar[l]^-{\ensuremath{\Conid{Cons}}}
}
\end{eqnarray*}
\begin{center}
onde \ensuremath{\Conid{S}\mathrel{=}\Conid{Stream}\;\Varid{a}}
\end{center}
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment  Função para visualizar os primeiros n elementos de um stream}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  Gerar stream de naturais começando em n, incrementando de step}{}\<[E]%
\\
\>[B]{}\Varid{natsFrom}\mathbin{::}\Conid{Int}\to \Conid{Int}\to \Conid{Stream}\;\Conid{Int}{}\<[E]%
\\
\>[B]{}\Varid{natsFrom}\;\Varid{start}\;\Varid{step}\mathrel{=}\lanabracket\,\lambda \Varid{x}\to (\Varid{x},\Varid{x}\mathbin{+}\Varid{step})\,\ranabracket\;\Varid{start}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  Streams de teste}{}\<[E]%
\\
\>[B]{}\Varid{nats1}\mathbin{::}\Conid{Stream}\;\Conid{Int}{}\<[E]%
\\
\>[B]{}\Varid{nats1}\mathrel{=}\Varid{natsFrom}\;\mathrm{1}\;\mathrm{1}{}\<[29]%
\>[29]{}\mbox{\onelinecomment  1, 2, 3, 4, 5, ...}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{nats10}\mathbin{::}\Conid{Stream}\;\Conid{Int}{}\<[E]%
\\
\>[B]{}\Varid{nats10}\mathrel{=}\Varid{natsFrom}\;\mathrm{10}\;\mathrm{10}{}\<[29]%
\>[29]{}\mbox{\onelinecomment  10, 20, 30, 40, ...}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  Testes pré-definidos}{}\<[E]%
\\
\>[B]{}\Varid{test1}\mathbin{::}[\mskip1.5mu \Conid{Int}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{test1}\mathrel{=}\Varid{takeStream}\;\mathrm{16}\;(\Varid{fair\char95 merge'}\;(i_1\;(\Varid{nats1},\Varid{nats10}))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{test2}\mathbin{::}[\mskip1.5mu \Conid{Int}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{test2}\mathrel{=}\Varid{takeStream}\;\mathrm{16}\;(\Varid{fair\char95 merge'}\;(i_2\;(\Varid{nats1},\Varid{nats10}))){}\<[E]%
\ColumnHook
\end{hscode}\resethooks

O resultado de \ensuremath{\Varid{test1}} mostra a alternância começando pelo stream A (1, 2, 3, ...),
enquanto \ensuremath{\Varid{test2}} mostra a alternância começando pelo stream B (10, 20, 30, ...).
...
A mensagem a transmitir é \ensuremath{\Varid{words}\;\text{\ttfamily \char34 Vamos~atacar~hoje\char34}\mathrel{=}[\mskip1.5mu \text{\ttfamily \char34 Vamos\char34},\text{\ttfamily \char34 atacar\char34},\text{\ttfamily \char34 hoje\char34}\mskip1.5mu]}.
O aparelho tem o seguinte comportamento:
\begin{itemize}
    \item Cada palavra tem 5\% de probabilidade de se perder (95\% de sucesso)
    \item No final, o aparelho envia \ensuremath{\text{\ttfamily \char34 stop\char34}}, mas falha 10\% das vezes (90\% de sucesso)
\end{itemize}

Queremos encontrar \ensuremath{\Varid{gene}} tal que \ensuremath{\Varid{transmitir}\mathrel{=}\Varid{pcataList}\;\Varid{gene}} descreva este comportamento.

\textbf{Análise do catamorfismo probabilístico}

O combinador \ensuremath{\Varid{pcataList}} é a versão probabilística de \ensuremath{\llparenthesis\, \cdot \,\rrparenthesis}:
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
...
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{h}\;[\mskip1.5mu \mskip1.5mu]{}\<[14]%
\>[14]{}\mathrel{=}\Varid{g}\;(i_1\;()){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
...
A diferença fundamental é que o gene \ensuremath{\Varid{g}} retorna uma distribuição \ensuremath{\fun{Dist}\;\Varid{b}},
e a composição usa o operador monádico \ensuremath{\bind } para propagar as probabilidades.
...
Isto significa que \ensuremath{\Varid{r}} representa o resultado (já probabilístico) da transmissão
da cauda da lista, e o gene decide se adiciona ou não o elemento actual.

\textbf{Derivação do gene}

O gene tem tipo \ensuremath{()+(\Conid{String},[\mskip1.5mu \Conid{String}\mskip1.5mu])\to \fun{Dist}\;[\mskip1.5mu \Conid{String}\mskip1.5mu]} e deve tratar dois casos:

\emph{Caso base} — \ensuremath{\Varid{gene}\;(i_1\;())}:

Não há mais palavras. O aparelho tenta enviar \ensuremath{\text{\ttfamily \char34 stop\char34}}:
\begin{itemize}
    \item Com probabilidade 0.9: sucesso, retorna \ensuremath{[\mskip1.5mu \text{\ttfamily \char34 stop\char34}\mskip1.5mu]}
    \item Com probabilidade 0.1: falha, retorna \ensuremath{[\mskip1.5mu \mskip1.5mu]}
\end{itemize}

\emph{Caso recursivo} — \ensuremath{\Varid{gene}\;(i_2\;(\Varid{palavra},\Varid{resto}))}:

Recebe a palavra actual e \ensuremath{\Varid{resto}}, que é o resultado da transmissão da cauda.
O aparelho tenta enviar a palavra:
\begin{itemize}
    \item Com probabilidade 0.95: sucesso, retorna \ensuremath{\Varid{palavra}\mathbin{:}\Varid{resto}}
    \item Com probabilidade 0.05: falha, retorna \ensuremath{\Varid{resto}} (palavra perdida)
\end{itemize}
...
\\
\>[B]{}\Varid{gene}\;(i_1\;()){}\<[31]%
\>[31]{}\mathrel{=}\Varid{choose}\;\mathrm{0.9}\;{}\<[45]%
\>[45]{}[\mskip1.5mu \text{\ttfamily \char34 stop\char34}\mskip1.5mu]\;{}\<[62]%
\>[62]{}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{gene}\;(i_2\;(\Varid{palavra},\Varid{resto}))\mathrel{=}\Varid{choose}\;\mathrm{0.95}\;(\Varid{palavra}\mathbin{:}\Varid{resto})\;\Varid{resto}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=1.5cm{
    \ensuremath{[\mskip1.5mu \Conid{String}\mskip1.5mu]}
           \ar[d]_-{\ensuremath{\Varid{pcataList}\;\Varid{gene}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}\Conid{String}\times[\mskip1.5mu \Conid{String}\mskip1.5mu]}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times\Varid{pcataList}\;\Varid{gene}}}
           \ar[l]_-{in_{List}}
\\
    \ensuremath{\fun{Dist}\;[\mskip1.5mu \Conid{String}\mskip1.5mu]}
&
    \ensuremath{\mathrm{1}\mathbin{+}\Conid{String}\times\fun{Dist}\;[\mskip1.5mu \Conid{String}\mskip1.5mu]}
           \ar[l]^-{\ensuremath{\Varid{gene'}}}
}
\end{eqnarray*}

onde \ensuremath{\Varid{gene'}\mathrel{=}\alt{\Varid{gene}\comp i_1}{\lambda (\Varid{a},\Varid{d})\to \Varid{d}\bind \lambda \Varid{r}\to \Varid{gene}\;(i_2\;(\Varid{a},\Varid{r}))}}
combina o gene com a propagação monádica das probabilidades.

\textbf{Verificação: cálculo manual das probabilidades}

Seja \ensuremath{\Varid{msg}\mathrel{=}[\mskip1.5mu \text{\ttfamily \char34 Vamos\char34},\text{\ttfamily \char34 atacar\char34},\text{\ttfamily \char34 hoje\char34}\mskip1.5mu]}. Calculemos \ensuremath{\Varid{pcataList}\;\Varid{gene}\;\Varid{msg}}:

\emph{Passo 1} — \ensuremath{\Varid{h}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\Varid{gene}\;(i_1\;())\mathrel{=}\Varid{choose}\;\mathrm{0.9}\;[\mskip1.5mu \text{\ttfamily \char34 stop\char34}\mskip1.5mu]\;[\mskip1.5mu \mskip1.5mu]}

Distribuição inicial:
\begin{displaymath}
D_0 = \left\{ \begin{array}{ll} \text{\ensuremath{[\mskip1.5mu \text{\ttfamily \char34 stop\char34}\mskip1.5mu]}} & \text{com prob. } 0.9 \\ \text{\ensuremath{[\mskip1.5mu \mskip1.5mu]}}  & \text{com prob. } 0.1 \end{array} \right.
\end{displaymath}

\emph{Passo 2} — \ensuremath{\Varid{h}\;[\mskip1.5mu \text{\ttfamily \char34 hoje\char34}\mskip1.5mu]\mathrel{=}\Varid{h}\;[\mskip1.5mu \mskip1.5mu]\bind \lambda \Varid{r}\to \Varid{gene}\;(i_2\;(\text{\ttfamily \char34 hoje\char34},\Varid{r}))}

Para cada resultado \ensuremath{\Varid{r}} de $D_0$, aplicamos \ensuremath{\Varid{gene}\;(i_2\;(\text{\ttfamily \char34 hoje\char34},\Varid{r}))}:
\begin{itemize}
    \item \ensuremath{\Varid{r}\mathrel{=}[\mskip1.5mu \text{\ttfamily \char34 stop\char34}\mskip1.5mu]}: \ensuremath{\Varid{choose}\;\mathrm{0.95}\;[\mskip1.5mu \text{\ttfamily \char34 hoje\char34},\text{\ttfamily \char34 stop\char34}\mskip1.5mu]\;[\mskip1.5mu \text{\ttfamily \char34 stop\char34}\mskip1.5mu]}
    \item \ensuremath{\Varid{r}\mathrel{=}[\mskip1.5mu \mskip1.5mu]}: \ensuremath{\Varid{choose}\;\mathrm{0.95}\;[\mskip1.5mu \text{\ttfamily \char34 hoje\char34}\mskip1.5mu]\;[\mskip1.5mu \mskip1.5mu]}
\end{itemize}

Distribuição após "hoje":
\begin{displaymath}
D_1 = \left\{ \begin{array}{lll}
\text{\ensuremath{[\mskip1.5mu \text{\ttfamily \char34 hoje\char34},\text{\ttfamily \char34 stop\char34}\mskip1.5mu]}} & 0.9 \times 0.95 &= 0.855 \\
\text{\ensuremath{[\mskip1.5mu \text{\ttfamily \char34 stop\char34}\mskip1.5mu]}}        & 0.9 \times 0.05 &= 0.045 \\
\text{\ensuremath{[\mskip1.5mu \text{\ttfamily \char34 hoje\char34}\mskip1.5mu]}}        & 0.1 \times 0.95 &= 0.095 \\
\text{\ensuremath{[\mskip1.5mu \mskip1.5mu]}}              & 0.1 \times 0.05 &= 0.005
\end{array} \right.
\end{displaymath}

\emph{Passo 3} — \ensuremath{\Varid{h}\;[\mskip1.5mu \text{\ttfamily \char34 atacar\char34},\text{\ttfamily \char34 hoje\char34}\mskip1.5mu]}: análogo, multiplica cada linha por 0.95 (sucesso) ou 0.05 (falha).

\emph{Passo 4} — \ensuremath{\Varid{h}\;[\mskip1.5mu \text{\ttfamily \char34 Vamos\char34},\text{\ttfamily \char34 atacar\char34},\text{\ttfamily \char34 hoje\char34}\mskip1.5mu]}: idem.
...
\item \textbf{Falta o "stop"}: \ensuremath{[\mskip1.5mu \text{\ttfamily \char34 Vamos\char34},\text{\ttfamily \char34 atacar\char34},\text{\ttfamily \char34 hoje\char34}\mskip1.5mu]}
\begin{displaymath}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{transmissao}\mathbin{::}\fun{Dist}\;[\mskip1.5mu \Conid{String}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{transmissao}\mathrel{=}\Varid{transmitir}\;(\Varid{words}\;\text{\ttfamily \char34 Vamos~atacar~hoje\char34}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  Probabilidade de transmissão perfeita}{}\<[E]%
\\
\>[B]{}\Varid{probPerfeita}\mathbin{::}\Conid{Probability}{}\<[E]%
\\
\>[B]{}\Varid{probPerfeita}\mathrel{=}(\equiv [\mskip1.5mu \text{\ttfamily \char34 Vamos\char34},\text{\ttfamily \char34 atacar\char34},\text{\ttfamily \char34 hoje\char34},\text{\ttfamily \char34 stop\char34}\mskip1.5mu])\mathbin{??}\Varid{transmissao}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  Probabilidade de faltar o "stop"}{}\<[E]%
\\
\>[B]{}\Varid{probSemStop}\mathbin{::}\Conid{Probability}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  Probabilidade de perder "atacar"}{}\<[E]%
\\
\>[B]{}\Varid{probPerdaAtacar}\mathbin{::}\Conid{Probability}{}\<[E]%
\\
...
\begin{itemize}
    \item \ensuremath{\Varid{probPerfeita}} $\approx 0.7716$
    \item \ensuremath{\Varid{probSemStop}} $\approx 0.0857$
    \item \ensuremath{\Varid{probPerdaAtacar}} $\approx 0.0406$
\end{itemize}
